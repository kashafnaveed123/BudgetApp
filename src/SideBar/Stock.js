...
//     "Kheermix (145g)کھیر مکس(M)",
//     "Pista Kheermix (145g)پستہ کھیرمکس(M)",
//     "Custurd strawberry(250g)کسٹرڈاسٹرابری(M)",
//     "Cuturd Mango(250g)کسٹرڈ مینگو(M)",
//     "Custurd Vanilla(250g)کسٹرڈ ونیلا(M)",
//     "Custurd Banana(250g)کسٹرڈبنانا(M)",
//     "Custurd strawberry(100g)کسٹرڈاسٹرابری(M)",
//     "Cuturd Mango(100g)کسٹرڈ مینگو(M)",
//     "Cuturd banana(100g)کسٹرڈ بنانا(M)",
//     "Cuturd Vanilla(100g)کسٹرڈ ونیلا(M)",
//     "Glucose(100g)گلوکوز(M)",
//     "Anerjelانرجل (M)",
//     "Biryani sachetبریانی ساشہ(M)",
//     "Qorma masala sachet قورمہ مصالحہ ساشہ(M)",
//     "Karahi Ghosht sachetکڑاہی گوشت ساشہ(M)",
//     "Machli Masala sachet(M)",
//     "Garam masla sachet گرم مصالحہ ساشہ(M)",
//     "kaali mirch sachetکالی مرچ ساشا(M)",
//     "Haldi sachetہلدی ساشہ(M)",
//     "Laal Mirch sachetلال مرچ (M)",
//     "Chaat masala sachetچاٹ مصالحہ ساشہ(M)",
//     "Murgi masala sachetمرغی مصالحہ ساشہ(M)",
//     "Dhaniya powder sachetدھنیا پاؤڈر (M)",
//     "Kabli Pulao کابلی پلاؤ (50g)(M)",
//     "Special Bombay Biryani سپیشل بمبئی بریانی (45g)(M)",
//     "Biryaniبریانی(45g)(M)",
//     "Qormaقورمہ(45g)(M)",
//     "Karahi Gosht masalaکڑاہی گوشت مصالحہ(45g)(M)",
//     "Achar Gosht masalaچار گوشت مصالحہ (45g)(M)",
//     "Brost masalaبروسٹ مصالحہ(45g)(M)",
//     "Tikka Boti masalaکہ بوٹی مصالحہ(45g)(M)",
//     "Chicken Tikka masalaچکن تکہ مصالحہ(45g)(M)",
//     "Haleem masalaحلیم مصالحہ(45g)(M)",
//     "Murgi masalaمرغی مصالحہ(45g)(M)",
//     "Machli masalaمچھلی مصالحہ (45g)(M)",
//     "Haldi powderہلدی پاؤڈر(45g)",
//     "Dhaniya Powderدھنیا پاؤڈر (45g)(M)",
//     "Chaat Masalaچاٹ مصالحہ(45g)(M)",
//     "Fruit Chaatفروٹ چاٹ(25g)(M)",
//     "Garam masalaگرم مصالحہ(25g)(M)",
//     "Kaali Mirchکالی مرچ (25g)(M)",
//     "laal Mirchسرخ مرچ(45g)(M)",
//     "Adrak Powderادرک پاؤڈر(45g)(M)",
//     "lehsanلہسن (45g)(M)",
//     "Qasori Meethiقصوری میتھی(25g)(M)",
//     "Dalia دلیہ (100g)(M)",
//     "Ispaghol chilkaاسپغول چھلکا(M)",
//     "Ispaghol Chilka Large Sachetاسپغول چھلکا بڑا ساشہ(M)",
//     "Biryani masala large sachet ریانی مصالحہ بڑا ساشہ(M)",
//     "Qorma masala large sachet قورمہ مصالحہ بڑا ساشہ(M)",
//     "Karahi Gosht Masala large sachet کڑاہی گوشت بڑا مصالحہ(M)",
//     "Achar Gosht Masala large sachet اچار گوشت بڑا مصالحہ(M) ",
//     "Achar Gosht Masala sachet اچار گوشت مصالحہ ساشہ(M)",
//     "Strawberry Custurd sachetکسٹرڈاسٹرابری ساشہ(M)",
//     "Mango Custurd sachet کسٹرڈ مینگو ساشہ(M)",
//     "Banana Custurd sachet کسٹرڈ بنانا ساشہ(M)",
//     "Vinallia Custurd sachetکسٹرڈ ونیلا ساشہ(M)",
//     "Sawaiyaسویاں(M)",
//     "Saalan masalaسالن مصالحہ(M)",
//     "Laal Mirch(R)سرخ مرچ",
//     "Dadar Mirchدادڈ مرچ(R)",
//     "Kaali Mirchکالی مرچ (R)",
//     "Kaali Mirch Powderکالی مرچ پاؤڈر(R)",
//     "Haldi ہلدی(R)",
//     "Dhaniya,دھنیا (R)",
//     "Dhaniya Powder دھنیاپاؤڈر(R)",
//     "Anaar Daanaاناردانا(R)",
//     "Daar Cheeniدار چینی(R)",
//     "Moti Ilaichموٹی الائچیi(R)",
//     "Saagu Daanaساگو دانا(R)",
//     "Zarda Rangزردا رنگ(R)",
//     "Sogi سوگی(R)",
//     "Khopra Giriکھوپرا گری(R)",
//     "Finger Chipsفنگر چپس(R)",
//     "Rewariریوڑی(R)",
//     "Zeera زیرا(R)",
//     "Loungلانگ(R)",
//     "Ispaghol Chilkaچھلکا اسپغول(R)",
//     "Imliاملی(R)",
//     "Khushk Soonfخشک سونف(R)",
//     "Ajwainاجوائن (R)",
//     "Meetha Soda میٹھا سوڈا(R)",
//     "Nimkoنمکو(R)",
//     "Meethi soonfمیٹھی سونف(R)",
//     "Chaneچنے(R)",
//     "Badaamبادام(R)(20Rs)",
//     "Sabz Ilaichiسبز الائچی(R)(20Rs)",
//     "Khajoorکھجور(R)(20)",
//     "Nimko نمکو (R) (20)",
//     "Qasoori Meethiقصوری میتھی(R)",
//     "Garam Masalaگرم مصالحہ(R)",
//     "Saabat Garam Masalaثابت گرم مصالحہ(R)",
//   ]);
...
//                 value={newSpice.name}
//                 onChange={(e) =>
//                   setNewSpice({ ...newSpice, name: e.target.value })
//                 }
...
//               onChange={(e) =>
//                 setNewSpice({ ...newSpice, quantity: Number(e.target.value) })
//               }
//               className="border border-gray-300 rounded p-2"
//             />
//             <button
...
//                   <>
//                     <span>
//                       {spice.name} (Quantity: {spice.quantity})
//                     </span>
//                     <div className="flex items-center space-x-2">
//                       <button
...
import React, { useState, useEffect } from "react";
import { db } from "./config/Firebase"; // Ensure Firebase is correctly configured
import {
  collection,
  addDoc,
  getDocs,
...
const Stock = () => {
  ...
  const addSpice = async () => {
    try {
      if (newSpice.name && newSpice.quantity > 0) {
        const docRef = await addDoc(collection(db, "spices"), newSpice);
        setSpices([...spices, { ...newSpice, id: docRef.id }]);
        setNewSpice({ name: "", quantity: 0 });
        setDropdownOpen(false); // Close dropdown after adding
