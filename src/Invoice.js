...
const Invoice = () => {
  ...
  const [isPrinting, setIsPrinting] = useState(false); // Track print mode
  ...
  const handlePrint = async () => {
    ...
    setTimeout(() => {
      window.print();
      setIsPrinting(false); // Revert back to edit mode
    }, 1000); // Wait for print dialog to open before resetting
  };
      ...
      <div className="text-center mb-8">
        ...
        <div className="flex justify-between mt-4">
          ...
          <div className="no-print">
            ...
            {isPrinting ? (
              <p>Customer's Shop Name: {invoiceDetails.shopName}</p>
            ) : (
              <input
                type="text"
